...
class UtilTest (unittest.TestCase):
    ...
    def test_4_generate_key_bytes(self):
        ...
        hex = ''.join(['{0:02x}'.format(bytord(c)) for c in x]).encode('ascii')
        self.assertEquals(hex, b'9110e2f6793b69363e58173e9436b13a5a4b339005741d5c680e505f57d871347b4239f14fb5c46e857d5e100424873ba849ac699cea98d729e57b3e84378e8b')
